...
ggsave("plt/hbench-runtime.svg", width = 5, height = 4, units = "in")
```
...
ggsave("plt/hbench-energy.svg", width = 8, height = 5, units = "in")
```
...
plt_profs <- ggplot(profs) + 
  ...
  scale_fill_brewer(name = "Runtime: ", palette = "Set1") + 
  theme_gray() + 
  theme(rect = element_rect(fill = "transparent", linewidth = 0), 
        panel.background = element_rect(fill = "#A9D3CD", linewidth = 0), 
        legend.key = element_rect(fill = "#A9D3CD"), 
...
ggsave("plt/opt-profiles.pdf", width = 8, height = 5, units = "in", 
       scale = 0.75)
ggsave("plt/opt-profiles.svg", width = 8, height = 5, units = "in", 
       scale = 0.75)
```
